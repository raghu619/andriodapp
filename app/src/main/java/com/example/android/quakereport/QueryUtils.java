...
/**
 * Created by raghvendra on 10/4/17.
 */
...
public   final class QueryUtils {
     ...
     */
    public static ArrayList<DATA> extractEarthquakes()  throws UnknownError
    {
        ...
        try {
            ...
            for (int i=0;i<features.length();i++)
            {
                ...
                JSONObject root1=features.getJSONObject(i);
                JSONObject properties=root1.getJSONObject("properties");
                ...
                DATA d=new DATA(magnitude,location,time,url);
                earthquakes.add(d);
